...
document.addEventListener('DOMContentLoaded', function () {
 ...
 // const day = document.getElementById("EventTitle").value;
  //const month = document.getElementById("EventDescription").value;
  //const year = document.getElementById("StartDate").value;
  //i need to find a way to pass all 6 values to the function
  const formattedDate = `${year}-${String(month).padStart(2, '0')}-${String(day).padStart(2, '0')}`;

            //created without ID because its auto generated by the database
            const eventData = {
